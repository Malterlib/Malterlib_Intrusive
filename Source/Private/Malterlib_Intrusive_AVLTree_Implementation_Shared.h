...
namespace NMib
{
	namespace NIntrusive
	{
		...
		inline_medium void TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fsp_RotateRight(CLinkPointer &_pObject)
		{
		...
		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		inline_medium void TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fsp_RotateLeft(CLinkPointer &_pObject)
		{
			CLink *tmp = CLink::fs_GetPtr(_pObject);
		...
		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		inline_medium bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fsp_RightShrunk(CLinkPointer &_pObject)
		{
		...
		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		inline_medium bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fsp_LeftShrunk(CLinkPointer &_pObject)
		{
			CLink *pObj = CLink::fs_GetPtr(_pObject);
			switch (pObj->f_GetSkew()) 
			{
		...
		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fsp_RightGrown(CLinkPointer &_pObject)
		{
			return fsp_RightGrown_Inl(_pObject);
		}

		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		inline_medium bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fsp_RightGrown_Inl(CLinkPointer &_pObject)
		{
			CLink *pObj = CLink::fs_GetPtr(_pObject);
			switch (pObj->f_GetSkew()) 
			{
		...
		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fsp_LeftGrown(CLinkPointer &_pObject)
		{
			return fsp_LeftGrown_Inl(_pObject);
		}

		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		inline_medium bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fsp_LeftGrown_Inl(CLinkPointer &_pObject)
		{
			CLink *pObj = CLink::fs_GetPtr(_pObject);
			switch (pObj->f_GetSkew()) 
			{
