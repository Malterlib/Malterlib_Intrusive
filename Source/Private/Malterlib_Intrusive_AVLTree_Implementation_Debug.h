...
namespace NMib
{
	namespace NIntrusive
	{
		...
		bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::fpr_CheckTree(CLink *_pCurrent, bint _bBreak, tf_CCompare &&_Compare, mint &_Depth)
		{
		...
		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::f_CheckTree(bint _bBreak)
		{
		...
		template <typename t_CLinkTraits, typename t_CCompare, typename t_CAllocator>
		template <typename tf_CCompare>
		bint TCAVLTreeAggregate<t_CLinkTraits, t_CCompare, t_CAllocator>::f_CheckTree(bint _bBreak, tf_CCompare &&_Compare)
		{
