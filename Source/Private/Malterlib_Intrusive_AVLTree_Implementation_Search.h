...
namespace NMib::NIntrusive
{
	...
	TCAVLTreeAggregate<t_pLinkMember, t_CCompare, t_CAllocator, t_COverrideNodeType>::f_FindEqual(const tf_CKey &_Key, tf_CCompare &&_Compare) const
	{
	...
	TCAVLTreeAggregate<t_pLinkMember, t_CCompare, t_CAllocator, t_COverrideNodeType>::f_FindSmallestGreaterThanEqual(const tf_CKey &_Key, tf_CCompare &&_Compare) const
	{
	...
	template <typename tf_CKey, typename tf_CCompare>
	inline_large typename TCAVLTreeAggregate<t_pLinkMember, t_CCompare, t_CAllocator, t_COverrideNodeType>::CNode *
	TCAVLTreeAggregate<t_pLinkMember, t_CCompare, t_CAllocator, t_COverrideNodeType>::f_FindSmallestGreaterThanEqualAndPrev(const tf_CKey &_Key, CNode* &_pPrev, tf_CCompare &&_Compare) const
	{
		CLink *pBestFit = nullptr;
		CLink *pPrev = nullptr;
	...
	template <typename tf_CKey, typename tf_CCompare>
	inline_large typename TCAVLTreeAggregate<t_pLinkMember, t_CCompare, t_CAllocator, t_COverrideNodeType>::CNode *
	TCAVLTreeAggregate<t_pLinkMember, t_CCompare, t_CAllocator, t_COverrideNodeType>::f_FindLargestLessThanEqual(const tf_CKey &_Key, tf_CCompare &&_Compare) const
	{
		CLink *pBestFit = nullptr;
