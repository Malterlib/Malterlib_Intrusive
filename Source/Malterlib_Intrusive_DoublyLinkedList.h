...
//						fp_GetLink()->fp_SetPrev(pLast);
		...
		{			
		private:
			DMibClassNoCopyAllowed(TCDLinkList);
		public:
...
#		define DMibListLinkD_LinkType NMib::NIntrusive::TDLink< NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator> >
#		define DMibListLinkD_Member(_Member) DMibListLinkD_LinkType _Member;
	
#		define DMibListLinkDA_LinkType NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>
...
#		define DMibListLinkD_List(_Class, _Member) NMib::NIntrusive::TCDLinkList<_Class, _Class::CDLinkTranslator##_Member, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, false, NMib::NMem::CDefaultAllocator>
#		define DMibListLinkD_ListAutoDelete(_Class, _Member) NMib::NIntrusive::TCDLinkList<_Class, _Class::CDLinkTranslator##_Member, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, true, NMib::NMem::CDefaultAllocator>
#		define DMibListLinkD_List_FromTemplate(_Class, _Member) NMib::NIntrusive::TCDLinkList<_Class, typename _Class::CDLinkTranslator##_Member, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, false, NMib::NMem::CDefaultAllocator>
#		define DMibListLinkD_ListAutoDelete_FromTemplate(_Class, _Member) NMib::NIntrusive::TCDLinkList<_Class, typename _Class::CDLinkTranslator##_Member, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, true, NMib::NMem::CDefaultAllocator>

#		define DMibListLinkDA_List(_Class, _Member) NMib::NIntrusive::TCDLinkListAggregate<_Class, _Class::CDLinkTranslator##_Member, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, false, NMib::NMem::CDefaultAllocator>
#		define DMibListLinkDA_ListAutoDelete(_Class, _Member) NMib::NIntrusive::TCDLinkListAggregate<_Class, _Class::CDLinkTranslator##_Member, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, true, NMib::NMem::CDefaultAllocator>
#		define DMibListLinkDA_List_FromTemplate(_Class, _Member) NMib::NIntrusive::TCDLinkListAggregate<_Class, typename _Class::CDLinkTranslator##_Member, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, false, NMib::NMem::CDefaultAllocator>
#		define DMibListLinkDA_ListAutoDelete_FromTemplate(_Class, _Member) NMib::NIntrusive::TCDLinkListAggregate<_Class, typename _Class::CDLinkTranslator##_Member, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, NMib::NIntrusive::TCDLinkAggregate<NMib::NMem::CDefaultAllocator>, true, NMib::NMem::CDefaultAllocator>
